...
# Catppuccin (Latte) by catppuccin (https://github.com/catppuccin)
# TODO: copy color names: https://github.com/augustebaum/base16-catppuccin-schemes/blob/main/catppuccin-latte.yaml
...
color03="fe/64/0b" # Base 0A - Yellow
color04="1e/66/f5" # Base 0D - Blue
color05="ea/76/cb" # Base 0E - Magenta
color06="17/92/99" # Base 0C - Cyan
color07="4c/4f/69" # Base 05 - White
color08="8c/8f/a1" # Base 03 - Bright Black
...
color15="7c/7f/93" # Base 07 - Bright White
color16="dc/8a/78" # Base 09
color17="e6/45/53" # Base 0F
color18="dc/e0/e8" # Base 01
color19="ac/b0/be" # Base 02
color20="7c/7f/93" # Base 04
color21="5c/5f/77" # Base 06
